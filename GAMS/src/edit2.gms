Sets
       ...
       / collection-centerAVehicle1, collection-centerBVehicle1 /
       ix 🎲available vehicles in collection centers servicing producer [collection-center -> producer|factory]
       / collection-centerAVehicle3,collection-centerBVehicle3 /
       ...
       / (collection-centerAVehicle1, collection-centerBVehicle1).(collection-centerA,collection-centerB) /
       ...
       / vehicle1-supplierA, vehicle1-supplierB /
...
*   it says waste but denotes p
    ...
    / (collection-centerAVehicle3,collection-centerBVehicle3).(collection-centerA, collection-centerB) 60 /
...
*   so don't use Spx in equations
    ...
    BRpe(p,e) The percentage of product p that returns from retailer e
    ...
    / (supplierA,supplierB).(vehicle1-supplierA,vehicle1-supplierB) 10 /
...
table feij(e,i,j) fxd transportation cost of vehicle i from [retailer e -> collection-center j]
                                                                                  collection-centerA    collection-centerB
(retailerA,retailerB).(collection-centerAVehicle1,collection-centerBVehicle1)          50                    50;
...
* where the constraints do not restrict the objective function and the objective goes to infinity.
* Both situations often arise due to errors or shortcomings in the formulation or in the data defining the problem.
